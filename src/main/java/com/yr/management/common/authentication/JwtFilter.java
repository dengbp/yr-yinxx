...
import com.yr.management.common.utils.SpringContextUtil;
...
public class JwtFilter extends BasicHttpAuthenticationFilter {
    ...
    protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue) throws UnauthorizedException {
        ...
        ErpProperties febsProperties = SpringContextUtil.getBean(ErpProperties.class);
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response) {
        ...
        JwtToken jwtToken = new JwtToken(LicenseUtil.decryptToken(token));
        try {
    ...
    protected boolean sendChallenge(ServletRequest request, ServletResponse response) {
        ...
        try (PrintWriter out = httpResponse.getWriter()) {
            String responseJson = "{\"code\":\"500,message\":\"" + message + "\"}";
