package com.yr.management.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://115.159.227.63:3306/Invoicing?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    ...
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.yr.management";
    // xml 文件模板
