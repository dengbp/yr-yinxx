...
import com.yr.management.common.function.CacheSelector;
...
/**
 * Description LicenseUtil
 * @Author dengbp
 * @Date 11:15 2019-11-20
 **/
@Slf4j
public class LicenseUtil {
   private static Pattern p = Pattern.compile("[\u4e00-\u9fa5]");
    ...
    public static User getCurrentUser() {
        ...
        log.info("获取当用户名称[JWTUtil.getUsername(token)={}]",username);
        ...
        try {
            ...
            log.info("获取当用户名称[cacheService.getUser(username).getUserName={}]",user.getUsername());
            return user;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static String encryptToken(String token) {
        try {
            EncryptUtil encryptUtil = new EncryptUtil(ERPConstant.TOKEN_CACHE_PREFIX);
