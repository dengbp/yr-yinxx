...
import com.yr.management.common.router.RouterMeta;
...
public class TreeUtil {
    ...
    public final static String TOP_NODE_ID = "0";
    public final static String FUNCTION_TOP_NODE_ID = "-1";
     ...
     * @return <T> Tree<T>
     */
    public static <T> Tree<T> build(List<Tree<T>> nodes, boolean disabled, boolean isSpan) {
        if (nodes == null) {
            return null;
        }
