 ...
 */
public final class RsaCodeUtil {
     ...
     * @throws Exception
     */
    public static byte[] decryptByPrivateKey(String data, String priKey)
            throws Exception {
        byte[] dataBytes = decryptBASE64(data);
        byte[] keyBytes = decryptBASE64(StringUtils.isBlank(priKey)?RSA_PRIVATE_VALUE:priKey);
        /* 取得私钥 **/
        PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(keyBytes);
     ...
     **/
    public static byte[] decryptByPublicKey(String data, String pubKey)
            throws Exception {

        byte[] dataBytes = decryptBASE64(data);
        byte[] keyBytes = decryptBASE64(StringUtils.isBlank(pubKey)?RSA_PUBLIC_VALUE:pubKey);
        /*取得公钥 **/
    ...
    public static String encryptByPublicKey(String data, String pubKey)
        ...
        if(blockSize>0){
            ...
            return RsaCodeUtil.encryptBASE64(raw);
        }
        return RsaCodeUtil.encryptBASE64(cipher.doFinal(dataBytes));
    }
