...
import com.yr.management.common.utils.MD5Util;
...
import com.yr.management.system.service.IUserConfigService;
...
public class UserController extends BaseController {
    ...
    public void addUser(@Valid User user) throws ERPException {
        try {
    ...
    public void updateUser(@Valid User user) throws ERPException {
        try {
    ...
    public void deleteUsers(@NotBlank(message = "{required}") @PathVariable String userIds) throws ERPException {
        try {
    ...
    @PutMapping("profile")
    public void updateProfile(@Valid User user) throws ERPException {
        try {
    ...
    public void updateAvatar(
            ...
            @NotBlank(message = "{required}") String avatar) throws ERPException {
        try {
    ...
    public void updateUserConfig(@Valid UserConfig userConfig) throws ERPException {
        try {
    ...
    public void updatePassword(
            @NotBlank(message = "{required}") String username,
            @NotBlank(message = "{required}") String password) throws ERPException {
        try {
    ...
    public void resetPassword(@NotBlank(message = "{required}") String usernames) throws ERPException {
        try {
    ...
    public void export(QueryRequestPage queryRequest, User user, HttpServletResponse response) throws ERPException {
        try {
