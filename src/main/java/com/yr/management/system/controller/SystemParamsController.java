...
import com.yr.management.common.enums.SysParamType;
import com.yr.management.common.utils.DateUtil;
import com.yr.management.common.utils.LicenseUtil;
import com.yr.management.system.Dto.SystemParamsDto;
import com.yr.management.system.entity.SystemParams;
import com.yr.management.system.service.SystemParamsService;
...
public class SystemParamsController extends BaseController {
    ...
    public LicenseResponse typeQuery() {
        ...
        for(SysParamType sysParamType : SysParamType.values()){
