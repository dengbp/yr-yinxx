...
public class RoleController extends BaseController {
    ...
    public void addRole(@Valid Role role) throws ERPException {
        try {
    ...
    public void deleteRoles(@NotBlank(message = "{required}") @PathVariable String roleIds) throws ERPException {
        try {
    ...
    public void updateRole(Role role) throws ERPException {
        try {
    ...
    public void export(QueryRequestPage queryRequest, Role role, HttpServletResponse response) throws ERPException {
        try {
