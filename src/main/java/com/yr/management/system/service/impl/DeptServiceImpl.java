...
import com.yr.management.common.entity.DeptTree;
...
import com.yr.management.system.mapper.DeptMapper;
...
public class DeptServiceImpl extends ServiceImpl<DeptMapper, Dept> implements IDeptService {
    ...
    public List<Dept> findDepts(Dept dept, QueryRequestPage request) {
        ...
        SortUtil.handleWrapperSort(request, queryWrapper, "orderNum", ERPConstant.ORDER_ASC, true);
