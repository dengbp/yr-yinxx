...
import com.yr.management.system.mapper.UserRoleMapper;
import com.yr.management.system.service.ICacheService;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    @Override
    public IPage<User> findUserDetail(User user, QueryRequestPage request) {
        try {
            Page<User> page = new Page<>();
            SortUtil.handlePageSort(request, page, "userId", ERPConstant.ORDER_ASC, false);
    ...
    public void updateLoginTime(User user) throws Exception {
        ...
        this.baseMapper.update(user, new LambdaQueryWrapper<User>().eq(User::getUsername, user.getUsername()));
