package com.yr.management.monitor.service.impl;
...
import com.yr.management.common.utils.AddressUtil;
import com.yr.management.common.utils.HttpContextUtil;
import com.yr.management.common.utils.IPUtil;
...
public class LoginLogServiceImpl extends ServiceImpl<LoginLogMapper, LoginLog> implements ILoginLogService {
    ...
    @Override
    public IPage<LoginLog> findLoginLogs(LoginLog loginLog, QueryRequestPage request) {
        ...
        SortUtil.handlePageSort(request, page, "loginTime", ERPConstant.ORDER_DESC, true);
